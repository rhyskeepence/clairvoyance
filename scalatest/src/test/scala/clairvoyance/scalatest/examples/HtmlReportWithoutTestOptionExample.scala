...
import clairvoyance.scalatest.export.single.ClairvoyantSpec
import org.scalatest.FunSuite

class HtmlReportWithoutTestOptionExample extends FunSuite with ClairvoyantContext with ClairvoyantSpec {
